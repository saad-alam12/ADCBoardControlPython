...
def get_psu_instance(psu_type):
    ...
    if config["instance"] is None:
        try:
            ...
            config["instance"] = run_psu.get_psu_instance(
...
def heinzinger_relay_state():
    ...
    try:
        ...
        print("ERROR reading Heinzinger relay state:", exc)
...
def heinzinger_set_relay():
    ...
    try:
        ...
        if not ok:
            return jsonify({"error": "Heinzinger PSU did not accept the command"}), 500
